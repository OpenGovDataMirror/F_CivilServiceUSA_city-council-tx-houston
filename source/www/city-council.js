  ...
  $.getJSON('city-council/data/city-council-data.json', function( data ) {
    ...
    $.each( data, function( key, val ) {
      ...
      var jsonld = {
        ...
        "url": "https://civilserviceusa.github.io/city-council-tx-houston/",
        "sameAs": []
      };
      ...
      jsonld.image = 'https://civilserviceusa.github.io/city-council-tx-houston/images/headshots/512x512/' + val.name_slug + '.jpg';
      jsonld.jobTitle = toTitleCase(val.title) + ' of Houston City Council';
